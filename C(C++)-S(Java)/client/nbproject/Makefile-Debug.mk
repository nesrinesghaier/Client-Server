...
${OBJECTDIR}/DAO/ClientDAO.o: DAO/ClientDAO.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DAO/ClientDAO.o DAO/ClientDAO.cpp

${OBJECTDIR}/DAO/TCPClientDAO.o: DAO/TCPClientDAO.cpp
	${MKDIR} -p ${OBJECTDIR}/DAO
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DAO/TCPClientDAO.o DAO/TCPClientDAO.cpp

${OBJECTDIR}/Presentation/Controller.o: Presentation/Controller.cpp
	${MKDIR} -p ${OBJECTDIR}/Presentation
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Presentation/Controller.o Presentation/Controller.cpp

${OBJECTDIR}/Presentation/Model.o: Presentation/Model.cpp
	${MKDIR} -p ${OBJECTDIR}/Presentation
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Presentation/Model.o Presentation/Model.cpp

${OBJECTDIR}/Presentation/View.o: Presentation/View.cpp
	${MKDIR} -p ${OBJECTDIR}/Presentation
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Presentation/View.o Presentation/View.cpp

${OBJECTDIR}/Service/ClientService.o: Service/ClientService.cpp
	${MKDIR} -p ${OBJECTDIR}/Service
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/ClientService.o Service/ClientService.cpp
